# vtp_eval/adapters/llava_baseline.py
"""Vanilla LLaVA-1.5 adapter — no pruning. Reference point for comparison."""
...
class LlavaBaseline(LlavaPruningBase):
    def __init__(self, pretrained: str = "liuhaotian/llava-v1.5-7b", **kw):
        ...
        self.pruning_meta = {"method": "baseline", "avg_tokens": 576}
