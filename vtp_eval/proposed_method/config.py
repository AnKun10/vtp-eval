...
class ProposedConfig:
    ...
    keep_position_ids: bool = False  # DEPRECATED / no-op. Stage 2 is now always
    #   no-slice + original position ids + full rotary (the only correct decode
    #   path). Kept as a field so old configs/from_args still parse; the forward
    #   ignores it.
